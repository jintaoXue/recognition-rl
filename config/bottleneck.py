...
config_env__neural_background_discrete_svo = copy.copy(config_env)
...
config_env__neural_background_discrete_svo.agents_master_cls = agents_master.AgentListMasterNeuralBackground
config_env__neural_background_discrete_svo.rule_vehicle_cls = agents_master.EndToEndVehicleWithCharacterBackground

config_env__neural_background_sampling = copy.copy(config_env)
