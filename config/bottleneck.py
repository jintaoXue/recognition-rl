...
config_env__with_character_fix_other_svo.scenario_randomization_cls = scenarios_template.ScenarioRandomizationFixOtherSvo
...
config_env__new_action_background.reward_func = reward.RewardFunctionRecogCharacterV2
