...
config_env__with_case_assign = copy.copy(config_env__with_character)
config_env__with_case_assign.scenario_cls = scenarios_merge.ScenarioMergeEvaluate_assign_case
