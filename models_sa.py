...
class isac_recog__bottleneck__adaptive(ModelPath):
    ...
    model_num = 220000
    model_num = 230000
    model_dir = '~/github/zdk/recognition-rl/results/IndependentSAC_recog-EnvInteractiveSingleAgent/2023-01-17-22:13:34----Nothing--isac_recog__new_adaptive/saved_models_method'
    model_num = 74000
...
class svos_as_action__bottleneck__adaptive(ModelPath):
    ...
    model_num = 300000
    model_dir = '~/github/zdk/recognition-rl/results/RecogV2-EnvInteractiveSingleAgent/2023-01-15-21:20:41----Nothing--recog__dynamic_action/saved_models_method'