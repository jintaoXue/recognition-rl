...
def evaluate_ray_isac_robust_character__bottleneck_assign(config, mode='evaluate', scale=5):
    from universe import EnvInteractiveMultiAgent as Env
...
def evaluate_ray_isac_adaptive_character__bottleneck_fix_svo(config, mode='evaluate', scale=1):
...
def evalute_ray_supervise__multiagent__bottleneck_assign_case_womap(config, mode='train', scale=5):
    from universe import EnvInteractiveMultiAgent as Env
    #todo
    from core.method_evaluate import EvaluateSupervise as Method
...
def evalute_ray_supervise__multiagent__bottleneck_assign_case_woattn(config, mode='train', scale=5):
    from universe import EnvInteractiveMultiAgent as Env
    #todo
    from core.method_evaluate import EvaluateSupervise as Method
...
def evalute_ray_supervise__multiagent__merge(config, mode='train', scale=1):
    from universe import EnvInteractiveMultiAgent as Env
    #todo
    from core.method_evaluate import EvaluateSupervise as Method
...
def evalute_ray_supervise__multiagent__merge_assign_case(config, mode='train', scale=5):
    from universe import EnvInteractiveMultiAgent as Env
    #todo
    from core.method_evaluate import EvaluateSupervise as Method
...
def evalute_ray_supervise__multiagent__merge_assign_character(config, mode='train', scale=5):
    from universe import EnvInteractiveMultiAgent as Env
    #todo
    from core.method_evaluate import EvaluateSupervise as Method

    ### env param
    from config.merge_evaluate import config_env__with_character_assign as config_merge
    # config_bottleneck.set('raw_horizon', config.raw_horizon)
    # config_bottleneck.set('horizon', config.horizon)
